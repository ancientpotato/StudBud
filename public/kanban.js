...
function getKanBanData() {
  ...
  if (document.getElementById('status1').checked) {
    ...
    localStorage.setItem('inProgressItems', JSON.stringify(inProgressItems)); //changing the obeject to a string since the element cannot grab objects
  ...
  this conditional will change the background colour of the priority (DOES NOT WORK)*/
...
//loop through the local storage of the kanban so it can show up on the screen
